...
>目前网上很多dubbo源码分析，文章繁多，质量参差不齐，大部分没有一个整体性。因为dubbo代码量很大，不可能讲的面面俱到，读之前，我们要想清楚自己到底要什么，有取舍的学习。沿着主线走下去，不要被旁路影响。很多文章，讲一个模块就只讲这个歌模块的东西，不会把其他关联的模块串起来，价值就大打折扣了。我希望这篇文章即可以单独当作一个独立、完整的学习教程，也可以和其他篇章前后贯通，形成一个系列。
